 ...
 * an Internet-accessible service. For both cases, the proxy servlet tries to access 
 * the backend service via a configured destination. The destination must be passed by 
 * the caller as part of the URL.
 * <p>
			...
			if (ceheader != null) {
				...
				for (HeaderElement codec : codecs) {
					...
					if ("gzip".equals(codecname) || "x-gzip".equals(codecname)) {
						...
						throw new ServletException("Unsupported Content-Coding: " + codec.getName());
					}
				}
			}
		}
